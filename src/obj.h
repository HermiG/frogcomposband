...
extern bool obj_is_not_ammo(obj_ptr obj);
extern bool obj_is_parchment(obj_ptr obj);
...
extern bool obj_is_bag(obj_ptr obj);
...
extern bool obj_is_weapon_or_shield(obj_ptr obj);
...
extern void special_drop(obj_ptr obj);
extern void special_remove(int slot, byte where);
#endif
